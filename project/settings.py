...
SECRET_KEY = 'django-insecure-zl-so7lw%ol32(s#ae@&^5)76)ti85a50ybt64mw!kx*h**ukc'
...
# Define TEMPLATE_DIR relative to the base directory
...
# Enable Django's timezone support (it's enabled by default)
USE_TZ = True
